...
export default function Home() {
  ...
  const categories = [
    { name: 'Rings', image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=600&q=80', desc: 'Solitaires & Pavé Bands' },
    ...
    { name: 'Bangles', image: 'https://images.unsplash.com/photo-1601821324082-c6193f00a50a?auto=format&fit=crop&w=600&q=80', desc: 'Hand-Engraved 22k Gold' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.map((cat) => (
            <Link
              ...
              className="group relative h-44 rounded-2x2 overflow-hidden border border-gold/20 hover:border-gold transition-all shadow-lg"
            >
              <img
                src={cat.image}
                alt={cat.name}
